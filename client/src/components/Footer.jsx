...
const Footer = () => {
  ...
  const TwitterIcon = () => (
    ...
    >
      <path
        d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1
  ...
  const YoutubeIcon = () => (
    ...
    >
      <path
        d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2
      ...
      <div className="relative z-10">
        ...
        <div className="py-12 max-w-7xl mx-auto px-6 grid md:grid-cols-4 sm:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-gray-300">
              ...
              commercial projects across NCR with a focus on quality and timely
              delivery.
            </p>
          </div>
        ...
        <div className="text-gray-400 text-xs px-6 md:px-20 py-6 leading-relaxed border-t border-gray-700 space-y-3">
          <p>
            ...
            only and does not constitute an offer or contract. Prices and
            availability are subject to change without prior notice. Project ID:
            UPRERAPRJ531916/06/2025
          </p>
          <p>
            Images and visuals are for illustration purposes and may differ from
            actual construction. This website functions as an authorized
            marketing partner and may share customer details with
            RERA-registered brokers for necessary processing.
          </p>
          <p>
            By submitting your details on this site, you agree to our Privacy
            Policy and Terms of Use.
          </p>
          <p>
            For the most accurate and updated details, please connect directly
            with our official sales team.
          </p>
        </div>

        {/* Bottom Bar */}
        <div className="text-center text-xs text-gray-500 border-t border-gray-700 py-4">
          © {new Date().getFullYear()} Property Expert Realtor Pvt. Ltd. (RERA
          ID: UPRERAAGT23257).
          <br />
